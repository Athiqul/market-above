<?php
$companyInfo=companyInfo($report->company_id);
...
<div class="row">
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Update Meeting Report</h4>

                <p class="card-title-desc">Please Provide Proper and Authentic information</p>


                <?= form_open('/meeting/update/'.$report->id, "class='custom-validation' novalidate=''") ?>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="company_name" value="<?=old('company_name',$companyInfo->company_name)?>" id="companyName" readonly />
                   
                    <div class="invalid-feedback">
                        Please select a valid thana.
                    </div>
                  <input type="hidden" name="company_id" value="<?=old('company_id',$companyInfo->id)?>" id="company_id" required >
                </div>
                <div class="mb-3">
                    <label>Contact Person:</label>
                    <div>
                        <input type="text" class="form-control" name="contact_person" value="<?= old('contact_person',$report->contact_person) ?>" required="">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" class="form-control" name="desg" value="<?= old('desg',$report->desg) ?>" required="">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="tel" class="form-control" name="mobile" value="<?= old('mobile',$report->mobile) ?>" pattern="01[3-9][0-9]{8}|[0-9]{8,11}" required="">
                ...
                <div class="mb-3">
                    <label>E-Mail</label>
                    <div>
                        <input type="email" class="form-control" name="email" value="<?= old('email',$report->email) ?>" parsley-type="email">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <textarea required="" class="form-control" rows="5" name="summary"><?= old('summary',$report->summary) ?></textarea>
    ...
    <div class="form-check form-check-inline mb-3 col-md-3">
        <input class="form-check-input" type="checkbox" id="formCheck1" name="services[]" value="<?=$item->id?>" <?=array_search($item->id,$check,false)?'checked':''?> >
