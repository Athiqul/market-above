                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Company Data Tables</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <h4 class="card-title">Company Reports</h4>
                <p class="card-title-desc">All Company  List.
                </p>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 0px;" aria-label="Meet With: activate to sort column ascending">Mobile</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 0px;" aria-label="Contact: activate to sort column ascending">Address</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 0px;" aria-label="Agent: activate to sort column ascending">Url</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 0px;" aria-label="Date: activate to sort column ascending">Description</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 0px;" aria-label="Date: activate to sort column ascending">Added By</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 0px;" aria-label="Date: activate to sort column ascending">Created At</th>
                                        ...
                                        <?php foreach ($items as $key=>$item) : ?>
                                            <tr class="odd">
                                                ...
                                                <td class="sorting_1 dtr-control" style="width:40px;"><?= $item->company_name ?></td>
                                                <td style="width:40px;"><?= $item->email?></td>
                                                <td style=""><?= $item->mobile ?></td>
                                                <td style=""><?= $item->address ?></td>
                                                <td style=""><?= $item->url??'No website' ?></td>
                                                <td style=""><?= $item->desc??'No description' ?></td>
